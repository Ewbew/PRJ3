 ...
 **************************************/
#define Counter_CAPTURE_MODE_CONF       1u
#define Counter_INIT_PERIOD_VALUE       65500u
...
#else
#define Counter_INIT_COMPARE_VALUE      65500u
#define Counter_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << Counter_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
        ((uint8)((uint8)1u << Counter_STATUS_CAPTURE_INT_EN_MASK_SHIFT)) | \
...
#define Counter_DEFAULT_COMPARE_MODE    0u

#if( 0 != Counter_CAPTURE_MODE_CONF)
    #define Counter_DEFAULT_CAPTURE_MODE    ((uint8)((uint8)1u << Counter_CTRL_CAPMODE0_SHIFT))
#else    
    #define Counter_DEFAULT_CAPTURE_MODE    (1u )
