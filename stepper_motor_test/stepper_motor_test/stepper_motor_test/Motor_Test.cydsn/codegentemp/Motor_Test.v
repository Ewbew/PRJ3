...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("12eb1cd1-08ba-498f-b884-dee2c8e6e574"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4ff322d2-4c41-411d-b0b2-d6ac324b4e5a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__A_ENABLE_net;
	wire [0:0] tmpFB_0__A_ENABLE_net;
	wire [0:0] tmpIO_0__A_ENABLE_net;
	wire [0:0] tmpINTERRUPT_0__A_ENABLE_net;
	electrical [0:0] tmpSIOVREF__A_ENABLE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1426819e-cd2b-4351-afaf-5cf73d5c6dd5"),
		  ...
		  .input_buffer_sel(2'b00))
		A_ENABLE
		 (.oe(tmpOE__A_ENABLE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__A_ENABLE_net[0:0]}),
		  .io({tmpIO_0__A_ENABLE_net[0:0]}),
		  .siovref(tmpSIOVREF__A_ENABLE_net),
		  .interrupt({tmpINTERRUPT_0__A_ENABLE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__A_ENABLE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__B_ENABLE_net;
	wire [0:0] tmpFB_0__B_ENABLE_net;
	wire [0:0] tmpIO_0__B_ENABLE_net;
	wire [0:0] tmpINTERRUPT_0__B_ENABLE_net;
	electrical [0:0] tmpSIOVREF__B_ENABLE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c157a266-02e7-4670-8e81-3f418d5f0045"),
		  ...
		  .input_buffer_sel(2'b00))
		B_ENABLE
		 (.oe(tmpOE__B_ENABLE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__B_ENABLE_net[0:0]}),
		  .io({tmpIO_0__B_ENABLE_net[0:0]}),
		  .siovref(tmpSIOVREF__B_ENABLE_net),
		  .interrupt({tmpINTERRUPT_0__B_ENABLE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B_ENABLE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("a710f5b9-6369-4030-99c3-0a346a179b6d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("42c65073-0e71-412b-82c5-bb7f5acd5a36"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
