...
module top ;
	...
	wire [0:0] tmpOE__DirPin_net;
	wire [0:0] tmpFB_0__DirPin_net;
	wire [0:0] tmpIO_0__DirPin_net;
	wire [0:0] tmpINTERRUPT_0__DirPin_net;
	electrical [0:0] tmpSIOVREF__DirPin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		DirPin
		 (.oe(tmpOE__DirPin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DirPin_net[0:0]}),
		  .io({tmpIO_0__DirPin_net[0:0]}),
		  .siovref(tmpSIOVREF__DirPin_net),
		  .interrupt({tmpINTERRUPT_0__DirPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DirPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__StepPin_net;
	wire [0:0] tmpFB_0__StepPin_net;
	wire [0:0] tmpIO_0__StepPin_net;
	wire [0:0] tmpINTERRUPT_0__StepPin_net;
	electrical [0:0] tmpSIOVREF__StepPin_net;

	cy_psoc3_pins_v1_10
		#(.id("d41ecedc-4b39-4dac-9c4f-f8acf10586d2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		StepPin
		 (.oe(tmpOE__StepPin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__StepPin_net[0:0]}),
		  .io({tmpIO_0__StepPin_net[0:0]}),
		  .siovref(tmpSIOVREF__StepPin_net),
		  .interrupt({tmpINTERRUPT_0__StepPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__StepPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
